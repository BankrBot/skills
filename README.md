...
| [ICM](https://useicm.com) | [icm-operator](icm-operator/) | AI personality network: public `llm.txt` identity, relationship mailboxes, evidence graphs, Drive/GitHub/social ingest, private guidance, claims, and versioned decision memory. |
