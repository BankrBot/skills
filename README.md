...
| Contract Risk Scanner | [contract-risk-scanner](contract-risk-scanner/) | Pre-trade smart contract risk scanner for AI agents. Checks honeypot risk, privileged ownership, upgradeability, transfer restrictions, and execution safety, then returns GO, CAUTION, or AVOID recommendations. |
