...
| [x402 QAI](https://qai.0x402.sh) | [x402-qai](x402-qai/) | x402 compliance scanner and marketplace explorer. Scan endpoints for spec compliance, browse the x402 service marketplace, get shareable reports and embeddable badges, and estimate workflow costs. All endpoints free. |
| [CannaStack](https://cannastack.0x402.sh) | [cannastack](cannastack/) | Cannabis dispensary data for AI agents. Search strains, compare prices, find deals, and track price history across 13 US metro areas. 600+ dispensaries, 7000+ menu items, updated every 6 hours. All endpoints free. |
