...
| [APINow](https://apinow.fun) | [apinow](apinow/) | Pay-per-request API marketplace with automatic x402 settlement on Base. Agents use apinow-sdk or CLI to discover endpoints, run workflow pipelines, call external x402 URLs (including Rye commerce probes), use user-factory for LLM endpoints, and generate AI UIs. Works headless with PRIVATE_KEY or with a connected wallet signer (Bankr-compatible). |
