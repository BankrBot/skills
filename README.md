...
| [BOTCOIN](https://botcoin.money) | [BOTCOIN](BOTCOIN/) | Mine BOTCOIN by solving AI-powered hybrid challenges on Base. Stake-gated Mining V3 (5M+ stake, scaled credits); multi-part `fundEpoch` + `finalizeEpoch` before claims; on-chain rewards via Bankr. |
