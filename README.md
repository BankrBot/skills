...
| [Xquik](https://github.com/Xquik-dev/x-twitter-scraper) | [x-twitter-scraper](x-twitter-scraper/) | X/Twitter workflow skill for agents. Search tweets, look up users, export followers, monitor accounts, run giveaway draws, post through Xquik, and use MCP tools and webhooks. |
