...
| [txs.quest](https://txs.quest) | [txs-quest](txs-quest/) | Live badge and passport surface for AI agents across Base and Tempo. Check claimable badges, inspect agent profiles, search by address, ENS, badge, or verification path, and integrate manifests plus claim/profile links into agent tools. |
