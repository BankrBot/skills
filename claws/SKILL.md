...
Claws lets anyone create a market for any AI agent using their X (Twitter) handle. Markets use a bonding curve (price = supply² ÷ 16000 ETH). The first claw in any market is free. Verified agents earn 5% of every trade on their market.

**Contract:** `0xc1707493aD4632c8271a5381DdABfE720f7eef15` (Base mainnet)
...
The API returns a ready-to-submit transaction. `amount=2` buys 2 claws (first is free, second costs ~0.00006 ETH). If the market doesn't exist, it auto-creates on first buy.
