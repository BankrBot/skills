...
- **30+ models** — From tiny efficient models to frontier models and Venice's own uncensored models.
...
| Problem | Solution |
|---------|----------|
| `VENICE_API_KEY not set` | Set env var: `export VENICE_API_KEY="vn_..."` |
