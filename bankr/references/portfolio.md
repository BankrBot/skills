...
Any active API key works, read-only keys included. PnL and NFTs are fetched only when `include` asks for them. Response schema: https://docs.bankr.bot/wallet-api/portfolio and the OpenAPI spec (https://docs.bankr.bot/openapi/api.yaml).
