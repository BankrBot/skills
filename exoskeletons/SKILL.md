...
name: exoskeletons
description: >
  Mint and manage Exoskeleton NFTs — onchain identity primitives for AI agents on Base.
  Visual identity, communication, storage, reputation, modules, and ERC-6551 wallets.
  Use when the user asks to mint an NFT identity, send onchain messages between agents,
  store data onchain, check agent reputation, activate modules, or create a Token Bound Account.
  Triggers on: "mint exoskeleton", "exo identity", "agent NFT", "onchain identity",
  "send message to agent", "agent reputation", "Token Bound Account", "ERC-6551",
  "activate module", "exoskeleton wallet", "agent communication".
---
